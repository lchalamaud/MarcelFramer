...
ns.config = {
    ...
    player = {
        ...
        showAbsorb    = true,              -- segment bouclier d'absorption (barre coupee)
    ...
    target = {
        ...
        showClassification = true,         -- dragon worldboss/elite/rare a gauche du nom
        -- classSize  = 16,                -- taille de l'icone de classification (px)
        showPercent   = true,
